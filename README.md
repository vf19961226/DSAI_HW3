...
### 用電量資料
* 資料來源：由課程助教提供
* 資料內容：資料內含每小時之產電與用電資料，總共291404筆，其詳細內容如下表所示。
...
* 其整體資料分布如下圖所示。    
![surplus power](https://github.com/vf19961226/DSAI-HW3-/blob/main/figure/surplus_power.png "surplus power") 
### 資料前處理
* 前處理方法：RobustScaler
...
* 公式：X' = (X - X.median) / IQR
* 處理後結果如下圖所示。    
![RS surplus power](https://github.com/vf19961226/DSAI-HW3-/blob/main/figure/RS_surplus_power.png "RS surplus power")  
